...
SECRET_KEY = 'django-insecure--ma1dmi4@+m!3vkfi24mz)@)30*uf40$ho-h3o&ik*n90w6-re'
...
INSTALLED_APPS = [
    ...
    'scanner', # la app que desarrollaré
]
...
WSGI_APPLICATION = 'revision_ci.wsgi.application'
